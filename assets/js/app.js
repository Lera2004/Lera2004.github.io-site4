...
export const updateWeather = function (lat, lon) {
   ...
   fetchData(url.currentWeather(lat, lon), function (currentWeather) {
      ...
      card.innerHTML = `
         ...
         <p class="body-3">${getDescriptionInRussian(description)}</p>
      ...
      `;
      function getDescriptionInRussian(englishDescription) {
         const translations = {
            "clear sky": "ясне небо",
            "few clouds": "трохи хмар",
            ...
            "snow": "сніг",
            "mist": "туман"
            // ... Додайте інші переклади за потребою
         };
      ...
      fetchData(url.airPollution(lat, lon), function (airPollution) {
         ...
         card.innerHTML = `
            <h2 class="title-2" id="highlights-label">Основні моменти сьогоднішнього дня</h2>
            ...
            <div class="highlight-list">
               ...
               <div class="card card-sm highlight-card two">
                  ...
                  <h3 class="title-3">Схід та захід сонця</h3>
               ...
               <div class="card card-sm highlight-card">
                  ...
                  <h3 class="title-3">Відчуття, ніби</h3>
